...
<template>
  <div
    class="max-w-md mx-auto mt-20 p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700"
  >
    ...
    <div
      v-if="error"
      class="bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 p-4 rounded-lg mb-6 text-sm flex items-center gap-2"
    >
      <svg
        class="w-5 h-5"
        fill="none"
