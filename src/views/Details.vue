...
<template>
  <div v-if="loading" class="flex justify-center items-center h-[70vh]">
      ...
      <div class="relative h-[600px] lg:h-[850px] w-full">
        ...
        <div class="absolute inset-0 flex flex-col justify-end">
           ...
           <div class="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pb-12 flex flex-col md:flex-row gap-10 items-end">
            ...
            <p
              v-if="media.tagline"
              class="text-xl md:text-2xl text-gray-500 dark:text-gray-400 italic mb-6 font-light"
            >
              "{{ media.tagline }}"
            </p>

            <div
              class="flex flex-wrap items-center gap-4 text-sm md:text-lg font-medium opacity-90 mb-8"
            >
              <span
                class="bg-gray-200 dark:bg-gray-800/80 backdrop-blur-md px-4 py-1.5 rounded-full border border-gray-300 dark:border-gray-700"
              >
            ...
            <div class="flex flex-wrap items-center gap-6">
              <div
                class="flex items-center gap-4 bg-white/50 dark:bg-black/50 backdrop-blur-md rounded-full px-6 py-3 border border-white/20 dark:border-white/10 shadow-sm"
              >
                <div
                ...
                >
                  ...
                  <span class="absolute text-sm font-bold"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-48 space-y-16">
