...
<template>
  <div class="flex items-center bg-gray-200 dark:bg-gray-800 rounded-full p-1">
    <button 
      @click="theme = 'light'" 
      :class="{'bg-white text-yellow-500 shadow-sm': theme === 'light', 'text-gray-500 dark:text-gray-400': theme !== 'light'}"
    ...
    <button 
      @click="theme = 'system'" 
      :class="{'bg-white text-blue-500 shadow-sm': theme === 'system', 'text-gray-500 dark:text-gray-400': theme !== 'system'}"
      class="p-1.5 rounded-full transition-all duration-200"
    ...
    <button 
      @click="theme = 'dark'" 
      :class="{'bg-gray-600 text-white shadow-sm': theme === 'dark', 'text-gray-500 dark:text-gray-400': theme !== 'dark'}"
      class="p-1.5 rounded-full transition-all duration-200"
      title="Dark Mode"
    >
