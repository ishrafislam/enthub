    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <div class="flex items-center">
          ...
          >
            <div
              class="w-8 h-8 bg-gradient-to-tr from-teal-400 to-blue-500 rounded-lg flex items-center justify-center transform group-hover:rotate-6 transition duration-300"
            >
              <span class="text-white font-bold text-lg">E</span>
            </div>
            <span
              class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-500 to-blue-600 dark:from-teal-400 dark:to-blue-500"
            >
              EntHub
            </span>
          </router-link>
        ...
        <div class="hidden md:flex items-center gap-6">
          <router-link
            to="/"
            class="text-gray-600 dark:text-gray-300 hover:text-teal-500 dark:hover:text-teal-400 font-medium transition"
          >
            Discover
          </router-link>
    ...
    >
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
        ...
        <div v-if="authStore.isAuthenticated()">
          ...
          >
          <button
            class="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-red-500 hover:bg-gray-100 dark:hover:bg-gray-800"
            @click="handleLogout"
          >
            Logout
          </button>
        ...
        <div v-else>
          <router-link
            to="/login"
            class="block px-3 py-2 rounded-md text-base font-medium text-teal-500 hover:bg-gray-100 dark:hover:bg-gray-800"
            >Login</router-link
          >
        </div>
      </div>
